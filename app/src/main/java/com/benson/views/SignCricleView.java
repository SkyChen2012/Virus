...
/**
 * com.benson.Tools
 * Created by Benson on 2017/11/10-下午6:56.
 */

public class SignCricleView  extends View{

    private final static String Tag = "SignCricleView";
...
//        mGradientRingPaint.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.i(Tag,"[width:" + width + "][radius:" + radius +"][oval1:" + oval1 +"][mOuterArc:" + mOuterArc +"]");
    ...
    private void drawArc(Canvas canvas) {
        ...
        //画最外层的渐变圆环
        canvas.rotate(50);
        Log.i(Tag,"[mOuterArc:" + mOuterArc + "][mStartAngle:" + mStartAngle +"][mDefaultRingPaint:" + mDefaultRingPaint + "]");
