package com.benson.Tools.Map;

import com.baidu.location.BDAbstractLocationListener;
import com.baidu.location.BDLocation;
import com.baidu.location.Poi;
import com.benson.Tools.Map.Bean.MapBean;
...
/**
 * com.benson.virus
 * Created by Benson on 2017/11/30-下午3:08.
 */
...
public class LocationActivity extends Activity {
    ...
    protected void onStart() {
        ...
        super.onStart();
        // -----------location config ------------
        locationService = ((virusApplication) getApplication()).locationService;
